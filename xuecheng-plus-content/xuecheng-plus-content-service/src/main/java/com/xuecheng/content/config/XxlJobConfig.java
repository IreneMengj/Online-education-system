...
public class XxlJobConfig {
    ...
    public XxlJobSpringExecutor xxlJobExecutor() {
        ...
        xxlJobSpringExecutor.setAdminAddresses("http://127.0.0.1:8088/xxl-job-admin");
        xxlJobSpringExecutor.setAppname("coursepublish-job");
//        xxlJobSpringExecutor.setAddress(null);
//        xxlJobSpringExecutor.setIp(null);
        xxlJobSpringExecutor.setPort(8999);
